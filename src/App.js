    ...
    return (
      <div className="is-preload">
			...
			<div id="main">
				...
				<div className="box alt container">
					<section className="feature left">
						<a href={"https://www.google.com"} className="image icon solid fa-signal"><img src="https://amp.businessinsider.com/images/56c4cd972e5265bc008b7bc2-750-563.png" alt="" /></a>
					...
					<section className="feature right">
						<a href={"https://www.google.com"} className="image icon solid fa-code"><img src="https://d3e1o4bcbhmj8g.cloudfront.net/photos/732303/big_square/5d5b7887cdb6df351e61eab5c286befb4e63fc52.jpg" alt="" /></a>
						<div className="content">
					...
					<section className="feature left">
						<a href={"https://www.google.com"} className="image icon solid"><img src="https://static.thenounproject.com/png/299353-200.png" alt="" /></a>
						<div className="content">
							<h3>Code Reviews</h3>
          ...
          <section>
						...
						<img style={{alignSelf: 'center'}} src="https://media.licdn.com/dms/image/C4E03AQEH28C26o6hwA/profile-displayphoto-shrink_200_200/0?e=1562803200&v=beta&t=o573GZ624gmK1P10oNogubPAe1nuMZMAg06vn5JmvAQ" alt="Nick Drishinski, Founder of The Jr. Devs" />
						</header>
            {/* <img style={{height: 40, width: 40, border: '1px solid black'}} src="images/pic01.jpg" alt="" /> */}
              ...
              every aspiring developer confidence that comes with valuable experience, so that they can get a great job feeling Authent Syndrome.
				...
				<footer className="major container medium">
					...
					<ul className="actions special">
						{/* <li><a href={"https://www.google.com"} className="button">Join our crew</a></li> */}
					</ul>
				</footer>
			...
			<div id="footer">
				<div className="container medium">
					...
					{/* <ul className="icons">
						...
						<li><a href={"https://www.google.com"} className="icon brands fa-github"><span className="label">Github</span></a></li>
						<li><a href={"https://www.google.com"} className="icon brands fa-dribbble"><span className="label">Dribbble</span></a></li>
					</ul> */}

					<ul className="copyright">
						<li>&copy; Nick Drishinski. All rights reserved.</li><li><a style={{opacity: 0.3}} href="http://html5up.net">HTML5 UP</a></li>
					</ul>
